...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			...
			<div class="login-page bk-img" style="background-image: url(img/5.jpg);">
		<div class="form-content">
			<div class="container">
			div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-light mt-4x">Hostel Management System <br> User Login </h1>
